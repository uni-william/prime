...
@Named
@ViewScoped
public class RelatorioResumoDespesasBean implements Serializable {
	...
	public void emitirRelatorio() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/rel_despesas_periodo.jasper", this.response, parametros,
				"Relatorio Resumo Despesas.pdf");
