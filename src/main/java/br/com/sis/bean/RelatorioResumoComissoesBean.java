...
@Named
@ViewScoped
public class RelatorioResumoComissoesBean implements Serializable {
	...
	public void emitirRelatorio() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/rel_comissao_periodo.jasper", this.response, parametros,
				"Relatorio Resumo Comissões.pdf");
