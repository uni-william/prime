...
@Named
@ViewScoped
public class SelecaoVeiculoIntermediacaoBean implements Serializable {
	...
	public void pesquisar() {
		veiculosFiltrados = veiculoRepository.filtradosDeParceiros(filter);
	}
	...
	public void inicializar() {
		...
		filter.setStatusVeiculo(StatusVeiculo.PATIO);
	}
	
	public void abrirSelecaoVeiculoIntermediacao() {
		Map<String, Object> options = new HashMap<String, Object>();
		options.put("resizable", false);
		options.put("contentHeight", 520);
		options.put("height", 520);
		options.put("modal", true);
		RequestContext.getCurrentInstance().openDialog("/dialogos/DialogVeiculoIntermediacao", options, null);
	}
