...
public enum Funcionalidade {
	...
	CANAL_ACESS("Canais de Divugação - Acesso"),
	CANAL_INSERT("Canais de Divugação - Inserir"),
	CANAL_EDIT("Canais de Divugação - Editar"),
	CANAL_DEL("Canais de Divugação - Excluir"),	
	FORMA_ACESS("Formas de pagamento - Acesso"),
	FORMA_INSERT("Formas de pagamento - Inserir"),
	FORMA_EDIT("Formas de pagamento - Editar"),
	FORMA_DEL("Formas de pagamento - Excluir"),		
